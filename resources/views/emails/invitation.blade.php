...
<![endif]-->
	...
	<style>
		@import url(https://static-forms.klaviyo.com/fonts/api/v1/XPwNpd/custom_fonts.css);
																...
																<td
																	...
																	<div class="content-padding first">
																		...
																		<div class="kl-row colstack"
																			...
																			<div class="kl-column"
																				style="display:table-cell;vertical-align:top;width:100%;display:none;">
																				...
																				<div class="mj-column-per-100 mj-outlook-group-fix component-wrapper"
																					...
																					<table border="0" cellpadding="0"
																						...
																						<tbody>
																							<tr>
																								<td class=""
																									style="vertical-align:top;padding-top:40px;padding-right:30px;padding-bottom:40px;padding-left:30px;">
																									<table border="0"
																										cellpadding="0"
																										cellspacing="0"
																										role="presentation"
																										...
																										<tbody>
																											<tr>
																												<td align="left"
																													...
																													<div
																														style="font-family:Geneva,Arial;font-size:16px;font-style:normal;font-weight:400;letter-spacing:0px;line-height:1.5;text-align:left;color:#222427;">
																														...
																														<div class="ql-block"
																															data-block-id="block-1ea17e05-a8e9-4b45-978e-dc02b44303d7">
																														</div>

																														<div class="ql-block"
																															data-block-id="block-3cce7fb5-8a17-45d0-aefa-b80a10e772ee">
																															<span
																																style="font-family: 'Open Sans', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-weight: bold;">
																																Hej,<br>
																														...
																														<div class="ql-block"
																															data-block-id="block-3cce7fb5-8a17-45d0-aefa-b80a10e772ee">
																															<span
																																style="font-family: 'Open Sans', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-weight: 400;">
																															</span>
																														</div>
																														<div class="ql-block"
																															data-block-id="block-3cce7fb5-8a17-45d0-aefa-b80a10e772ee">
																															<span
																																style="font-family: 'Open Sans', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-weight: 400;">{{ $company->name }}
																																har
																																inviteret
																																dig
																																til
																				...
																				<div class="mj-column-per-100 mj-outlook-group-fix component-wrapper"
																					...
																					<table border="0" cellpadding="0"
																						...
																						<tbody>
																							<tr>
																								<td class=""
																									style="vertical-align:top;padding-top:0px;padding-right:30px;padding-bottom:0px;padding-left:30px;">
																									<table border="0"
																										cellpadding="0"
																										cellspacing="0"
																										role="presentation"
																													...
																													<table
																														...
																														<tr>
																															<td align="center"
																																bgcolor="#260EFF"
																																role="presentation"
																																style="border:none;border-radius:5px;cursor:auto;mso-padding-alt:20px 50px 20px 50px;background:#260EFF;"
																																valign="middle">
																																<p
																																	style="padding-bottom:0; display:inline-block; background:#260EFF; color:#FFF; font-family:Arial; font-size:16px; font-weight:700; line-height:100%; letter-spacing:0; margin:0; text-decoration:none; text-transform:none; padding:20px 50px 20px 50px; mso-padding-alt:0; border-radius:5px">
																																	Opret
																																	dig
																																</p>
																															</td>
																											...
																											<tr>
																												<td align="left"
																													...
																													<div
																														style="font-family:Geneva,Arial;font-size:16px;font-style:normal;font-weight:400;letter-spacing:0px;line-height:1.5;text-align:left;color:#222427;">
																														<div class="ql-block"
																															data-block-id="block-c6a82085-50e1-4bf2-a56d-400549a2e9b8">
																															<br><br>
																															<div class="ql-block"
																																data-block-id="block-63c0f7b8-5e81-4476-ade3-abe478b68707">
																																<span
																																	style="font-family: 'Open Sans', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-weight: 400;">
																																	Du
																																	vil
																															...
																															<br>
																															<div class="ql-block"
																																data-block-id="block-3d9d1794-2b4c-4bd4-b20f-aa6a5fc6d4b3">
																																<span
																																	style="font-family: 'Open Sans', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-weight: 400;">
																																	<div class="ql-block"
																																		data-block-id="block-7a8cbad1-dd22-419f-92fd-18292c16c8d4">
																																		<span
																																			style="font-family: 'Open Sans', Arial, 'Helvetica Neue', Helvetica, sans-serif; font-weight: 400;">
																																		</span>
																																	</div>
																																	<div class="ql-block"
																																		data-block-id="block-7a8cbad1-dd22-419f-92fd-18292c16c8d4">
																																		<span
																																			style="font-weight: bold;">Med
																																			venlig
																																			hilsen,</span>
																																	</div>
																																	<div class="ql-block"
																																		data-block-id="block-ba131e3c-b006-4523-9225-b97386ed1dae">
																																		Team
																																		FordelPlus
																																	</div>
																																</span>
																		...
																		<div class="kl-row colstack"
																			style="display:table;table-layout:fixed;width:100%;">
																			<!--[if true]><td style="vertical-align:top;width:600px;"><![endif]-->
																			<div class="kl-column empty-column-placeholder"
																				style="display:table-cell;vertical-align:top;width:100%;">
																			</div>
																			<!--[if true]></td><![endif]-->
																		</div>
